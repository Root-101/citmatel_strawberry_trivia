...
class TriviaLevelAnimales {
  static final TriviaLevelDomain levelAnimales = TriviaLevelDomain(
    id: 9,
        ...
        question: [
          TriviaQuestionDomain(
              ...
              answers: [
                ...
                TriviaQuestionAnswerDomain(id: 3, answer: "Frutas."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Semillas."),
              ]),
          TriviaQuestionDomain(
              id: 2,
              correctAnswerId: 1,
              question:
                  "¿Cuál es el nombre científico de los humanos modernos?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Homo Sapiens."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Homo Ergaster."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Homo Erectus."),
                TriviaQuestionAnswerDomain(
                    id: 4, answer: "Homo Neanderthalensis."),
              ]),
          TriviaQuestionDomain(
              id: 3,
              correctAnswerId: 1,
              question: "¿Qué significa hipopótamo y en qué idioma?",
              answers: [
                TriviaQuestionAnswerDomain(
                    id: 1, answer: "Caballo de río (griego)."),
                TriviaQuestionAnswerDomain(
                    id: 2, answer: "Caballo de río (latín)."),
                TriviaQuestionAnswerDomain(
                    id: 3, answer: "Cerdo gordo (latín)."),
                TriviaQuestionAnswerDomain(
                    id: 4, answer: "Cerdo gordo (griego)."),
              ]),
        ],
      ),
      TriviaSubLevelDomain(
        ...
        question: [
          TriviaQuestionDomain(
              ...
              correctAnswerId: 1,
              question:
                  "¿El Kākāpō es un loro grande, no volador y nocturno nativo de qué país?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Nueva Zelanda."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Sudáfrica."),
          ...
          TriviaQuestionDomain(
              id: 2,
              correctAnswerId: 1,
              question: "¿De qué color es la piel de un oso polar?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Negra."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Blanca."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Carmelita."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Rosada."),
              ]),
          TriviaQuestionDomain(
              id: 3,
              correctAnswerId: 1,
              question:
                  "¿Hipocampo es el nombre en latín de qué criatura marina?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Caballo de mar."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Delfín."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Ballena."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Pulpo."),
              ]),
        ],
      ),
      TriviaSubLevelDomain(
        ...
        question: [
          TriviaQuestionDomain(
              id: 1,
              correctAnswerId: 1,
              question: "¿La cachemira es la lana de qué tipo de animal?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Cabra."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Oveja."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Camello."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Llama."),
              ]),
          TriviaQuestionDomain(
              id: 2,
              correctAnswerId: 1,
              question: "¿De qué están hechos los cuernos de rinoceronte?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Queratina."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Hueso."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Piel."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Marfil."),
              ]),
          TriviaQuestionDomain(
              id: 3,
              correctAnswerId: 1,
              question: "¿Cuántas patas tienen las mariposas?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "6."),
                TriviaQuestionAnswerDomain(id: 2, answer: "2."),
                TriviaQuestionAnswerDomain(id: 3, answer: "4."),
                TriviaQuestionAnswerDomain(id: 4, answer: "0."),
              ]),
        ],
      ),
      TriviaSubLevelDomain(
        ...
        question: [
          TriviaQuestionDomain(
              id: 1,
              correctAnswerId: 1,
              question: "¿Cuántas especies vivas conocidas de hienas hay?",
              answers: [
          ...
          TriviaQuestionDomain(
              ...
              correctAnswerId: 1,
              question:
                  "¿Qué animal fue parte de un experimento de domesticación ruso en 1959?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Zorros."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Palomas."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Osos."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Cocodrilos."),
              ]),
          TriviaQuestionDomain(
              id: 3,
              correctAnswerId: 1,
              question:
                  "¿La especie ahora extinta Tilacino era nativa de dónde?",
              answers: [
                TriviaQuestionAnswerDomain(
                    id: 1, answer: "Tasmania, Australia."),
                TriviaQuestionAnswerDomain(
                    id: 2, answer: "Baluchistán, Pakistán."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Valaquia, Rumania."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Oregón, EEUU."),
              ]),
        ],
      ),
      TriviaSubLevelDomain(
        ...
        question: [
          TriviaQuestionDomain(
              id: 1,
              correctAnswerId: 1,
              question: "¿Cuál es el nombre científico del lobo gris?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Canis Lupus."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Canis Aureus."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Canis Latrans."),
                TriviaQuestionAnswerDomain(
                    id: 4, answer: "Canis Lupus Lycaon."),
              ]),
          TriviaQuestionDomain(
              id: 2,
              correctAnswerId: 1,
              question: "¿Cuál de estos animales NO es un lagarto?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Tuátara."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Dragón de Komodo."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Monstruo Gila."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Iguana Verde."),
              ]),
          TriviaQuestionDomain(
              id: 3,
              correctAnswerId: 1,
              question: "¿Qué tipo de criatura es un bonobo?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Mono."),
                TriviaQuestionAnswerDomain(id: 2, answer: "León."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Loro."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Gato Montés."),
              ]),
        ],
      ),
      TriviaSubLevelDomain(
        ...
        question: [
          TriviaQuestionDomain(
              id: 1,
              correctAnswerId: 1,
              question: "¿A qué clase de animales pertenecen los tritones?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Anfibios."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Peces."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Reptiles."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Mamíferos."),
              ]),
          TriviaQuestionDomain(
              id: 2,
              correctAnswerId: 1,
              question:
                  "¿Cómo se llama la familia a la que pertenece el gato doméstico?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Felidae."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Felinae."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Felis."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Gatos."),
              ]),
          TriviaQuestionDomain(
              id: 3,
              correctAnswerId: 1,
              question: "¿Qué especie es un \"pollo de montaña\"?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Rana."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Pollo."),
          ...
          TriviaQuestionDomain(
              ...
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Halcón Peregrino."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Águila Dorada."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Leopardo."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Tábano."),
              ]),
        ],
      ),
      TriviaSubLevelDomain(
        ...
        question: [
          TriviaQuestionDomain(
              id: 1,
              correctAnswerId: 1,
              question: "El plato Fugu, ¿de qué familia de pescado está hecho?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Pez Globo."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Lubina."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Salmón."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Caballa."),
              ]),
          TriviaQuestionDomain(
              id: 2,
              correctAnswerId: 1,
              ...
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Fondo del océano."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Desierto."),
                TriviaQuestionAnswerDomain(
                    id: 3, answer: "Cima de una montaña."),
                TriviaQuestionAnswerDomain(
                    id: 4, answer: "Dentro de un árbol."),
              ]),
          TriviaQuestionDomain(
              id: 3,
              correctAnswerId: 1,
              question: "¿De qué color es el mirlo hembra?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Carmelita."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Negro."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Blanco."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Amarillo."),
              ]),
          TriviaQuestionDomain(
              id: 4,
              correctAnswerId: 1,
              question: "¿Cuántos dientes tiene un conejo adulto?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "28."),
      ...
      TriviaSubLevelDomain(
        ...
        question: [
          TriviaQuestionDomain(
              ...
              correctAnswerId: 1,
              question:
                  "¿Cuál es el nombre de una abeja macho que proviene de un huevo no fertilizado?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Zánganos."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Soldado."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Trabajador."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Hombre."),
              ]),
          TriviaQuestionDomain(
              id: 2,
              correctAnswerId: 1,
              question: "¿Cómo se llama la morada de un conejo?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Madriguera."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Nido."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Guarida."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Montículo."),
              ]),
          TriviaQuestionDomain(
              id: 3,
              correctAnswerId: 1,
              question: "¿Qué pájaro nace con garras en los dedos de las alas?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Hoatzín."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Cormorán."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Casuario."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Pájaro Secretario."),
              ]),
          TriviaQuestionDomain(
              id: 4,
              correctAnswerId: 1,
              ...
              answers: [
                ...
                TriviaQuestionAnswerDomain(id: 3, answer: "Anélido."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Placozoos."),
              ]),
        ],
      ),
      TriviaSubLevelDomain(
        ...
        question: [
          TriviaQuestionDomain(
              id: 1,
              correctAnswerId: 1,
              question: "¿Cuál es la serpiente venenosa más larga del mundo?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Cobra Rey."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Anaconda verde."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Taipan interior."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Serpiente de mar."),
              ]),
          TriviaQuestionDomain(
              id: 2,
              correctAnswerId: 1,
              question: "¿Qué especie de oso pardo no se ha extinguido?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Oso pardo sirio."),
                TriviaQuestionAnswerDomain(
          ...
          TriviaQuestionDomain(
              id: 3,
              correctAnswerId: 1,
              question: "¿Cuál es el nombre científico del oso polar?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Ursus Maritimus."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Ursus Spelaeus."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Ursus Arctos."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Oso Polar."),
              ]),
          TriviaQuestionDomain(
              id: 4,
              correctAnswerId: 1,
              question: "¿Por qué razón se \"reiría\" una hiena manchada?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Nerviosismo."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Emoción."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Agresión."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Agotamiento."),
              ]),
        ],
      ),
      TriviaSubLevelDomain(
        ...
        question: [
          TriviaQuestionDomain(
              id: 1,
              correctAnswerId: 1,
              question: "¿Cuál es el nombre científico del guepardo?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Acinonyx jubatus."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Panthera onca."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Lynx rufus."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Felis catus."),
              ]),
          TriviaQuestionDomain(
              id: 2,
              correctAnswerId: 1,
              question: "¿Cuál de estas especies no está extinta?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Dragón de Komodo."),
                TriviaQuestionAnswerDomain(
                    id: 2, answer: "León marino japonés."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Tigre de Tasmania."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Gacela saudí."),
              ]),
          TriviaQuestionDomain(
              id: 3,
              correctAnswerId: 1,
              question:
                  "A diferencia de la mayoría de las salamandras, ¿esta parte de un tritón es plana?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Cola."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Cabeza."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Dientes."),
          ...
          TriviaQuestionDomain(
              ...
              correctAnswerId: 1,
              question:
                  "Nombre de la proteína rica en cobre que crea la sangre azul en el pulpo antártico:",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Hemocianina."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Citocromo."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Hierro."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Metionina."),
              ]),
        ],
      ),
      TriviaSubLevelDomain(
        ...
        question: [
          TriviaQuestionDomain(
              id: 1,
              correctAnswerId: 1,
              question: "¿Cuál es el nombre científico del chimpancé común?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Pan trogloditas."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Gorila gorila."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Pan panisco."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Pantera Leo."),
              ]),
          TriviaQuestionDomain(
              id: 2,
              correctAnswerId: 1,
              question:
                  "¿Cuál de estas es una colonia de pólipos y no una medusa?",
              answers: [
                TriviaQuestionAnswerDomain(
                    id: 1, answer: "Carabela portuguesa."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Avispa de mar."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Irukandji."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Ortiga de mar."),
              ]),
          TriviaQuestionDomain(
              id: 3,
              correctAnswerId: 1,
              question:
                  "¿Cuál es el término común para la encefalopatía espongiforme bovina (BSE)?",
              answers: [
                TriviaQuestionAnswerDomain(
                    id: 1, answer: "Enfermedad de las vacas locas."),
                TriviaQuestionAnswerDomain(
                    id: 2, answer: "Enfermedad de Weil."),
                TriviaQuestionAnswerDomain(
                    id: 3, answer: "Fiebre de la leche."),
                TriviaQuestionAnswerDomain(
                    id: 4, answer: "Enfermedad de pies y boca."),
              ]),
          TriviaQuestionDomain(
              id: 4,
              correctAnswerId: 1,
              question: "¿Cuáles de estos NO son decápodos?",
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Eufausiáceos."),
                TriviaQuestionAnswerDomain(id: 2, answer: "Langostas."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Camarón."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Cangrejos."),
              ]),
          TriviaQuestionDomain(
              id: 5,
              correctAnswerId: 1,
              ...
              answers: [
                TriviaQuestionAnswerDomain(id: 1, answer: "Leopardo."),
                TriviaQuestionAnswerDomain(id: 2, answer: "León."),
                TriviaQuestionAnswerDomain(id: 3, answer: "Gacela de Thomson."),
                TriviaQuestionAnswerDomain(id: 4, answer: "Antílope berrendo."),
              ])
        ],
      ),
      TriviaSubLevelDomain(
